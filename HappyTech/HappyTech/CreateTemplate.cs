        ...
        {
            {
                ...
                try
                {
                    ...
                    DatabaseConnection.createTemplate("INSERT INTO templates (templateTitle, templateText, templateCategory, templateSuccessful) VALUES(@templateTitle, @templateText, @templateCategory, @templateSuccessful)", template.templateTitle, template.templateText, template.templateCategory, template.templateSuccessful);
